...
Java_cn_martinkay_dexkit_DexKitHelper_initDexKit(JNIEnv *env, jobject thiz,
...
Java_cn_martinkay_dexkit_DexKitHelper_release(JNIEnv *env, jobject thiz, jlong token) {
    ReleaseDexKitInstance(env, token);
}

extern "C"
JNIEXPORT jobject JNICALL
Java_cn_martinkay_dexkit_DexKitHelper_batchFindClassesUsedStrings(JNIEnv *env, jobject thiz,
                                                                  jlong token,
                                                                  jobject map,
...
extern "C"
JNIEXPORT jobject JNICALL
Java_cn_martinkay_dexkit_DexKitHelper_batchFindMethodsUsedStrings(JNIEnv *env, jobject thiz,
                                                                  jlong token,
                                                                  jobject map,
                                                                  jboolean advanced_match,
                                                                  jintArray dex_priority) {
...
Java_cn_martinkay_dexkit_DexKitHelper_findMethodBeInvoked(JNIEnv *env, jobject thiz,
                                                          jlong token,
...
extern "C"
JNIEXPORT jobject JNICALL
Java_cn_martinkay_dexkit_DexKitHelper_findMethodInvoking(JNIEnv *env, jobject thiz,
                                                         jlong token,
                                                         jstring method_descriptor,
                                                         jstring method_declare_class,
                                                         jstring method_declare_name,
...
extern "C"
JNIEXPORT jobjectArray JNICALL
Java_cn_martinkay_dexkit_DexKitHelper_findMethodUsedField(JNIEnv *env, jobject thiz,
                                                          jlong token,
...
extern "C"
JNIEXPORT jobjectArray JNICALL
Java_cn_martinkay_dexkit_DexKitHelper_findMethodUsedString(JNIEnv *env, jobject thiz,
                                                           jlong token,
                                                           jstring used_string,
                                                           jboolean advanced_match,
                                                           jstring method_declare_class,
...
extern "C"
JNIEXPORT jobjectArray JNICALL
Java_cn_martinkay_dexkit_DexKitHelper_findMethod(JNIEnv *env, jobject thiz,
                                                 jlong token,
                                                 jstring method_declare_class,
                                                 jstring method_name,
                                                 jstring method_return_type,
...
extern "C"
JNIEXPORT jobjectArray JNICALL
Java_cn_martinkay_dexkit_DexKitHelper_findSubClasses(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT jobjectArray JNICALL
Java_cn_martinkay_dexkit_DexKitHelper_findMethodOpPrefixSeq(JNIEnv *env, jobject thiz,
                                                            jlong token,
