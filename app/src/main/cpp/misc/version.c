...
#ifndef WECHATROAMING_VERSION
#error Please define macro WECHATROAMING_VERSION in CMakeList
#endif

__attribute__((used, noreturn, section(".entry_init")))
void __libwechatroaming_main(void) {
    printf("QAuxiliary libqauxv.so version " WECHATROAMING_VERSION ".\n"
