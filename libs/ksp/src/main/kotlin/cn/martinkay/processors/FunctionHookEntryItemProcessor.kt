...
class FunctionHookEntryItemProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        val symbols =
            resolver.getSymbolsWithAnnotation("cn.martinkay.wechatroaming.settings.base.annotation.FunctionHookEntry")
        ...
        FileSpec.builder(Config.kspGenPath, "AnnotatedFunctionHookEntryList")
